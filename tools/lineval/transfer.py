...
from mdistiller.dataset import (
    get_fgvc_aircraft_dataloaders,
    get_flowers102_dataloaders,
    get_food101_dataloaders,
    get_imagenet_r_dataloaders,
    get_inat2019_dataloaders,
    get_oxford_iiit_pet_dataloaders,
)
...
## Transfer learning must confirmed with belows.
## All are about image classification, thus those share code, based on imagenet classification.
## imagenet_cog also whould be better with, but we do not have that much storage :(
# fgvc_aircraft
# flowers102
# food101
# imagenet_r (this uses IN-1K finetuning)
# inat2019
# oxford_iiit_pet

DATASETS = {
    # 'dataset_name': (get_loaders_fn, num_classes) #
    'aircraft': (get_fgvc_aircraft_dataloaders, 100),
