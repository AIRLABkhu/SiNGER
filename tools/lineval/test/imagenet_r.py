...
import torch
from mdistiller.dataset.imagenet_r import get_imagenet_r_dataloaders
...
def main(args: Namespace):
    ...
    # DataLoaders, Models
    _, test_loader, _ = get_imagenet_r_dataloaders(
        1, args.batch_size,
...
if __name__ == '__main__':
    parser = ArgumentParser('lineval.test.imagenet-r')
