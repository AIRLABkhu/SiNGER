...
import torch
from mdistiller.dataset.imagenet_v2 import get_imagenet_v2_dataloaders
...
def main(args: Namespace):
    ...
    # DataLoaders, Models
    _, test_loader, _ = get_imagenet_v2_dataloaders(
        1, args.batch_size,
...
if __name__ == '__main__':
    parser = ArgumentParser('lineval.test.imagenet-v2')
